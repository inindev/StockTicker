 ...
 *
 * Like [StocksApi] and 'NewsProvider', this is a plain, platform-agnostic class with no Android
 * dependencies. The changelog is generated from git into the shared [ChangelogBuildConfig.CHANGE_LOG]
 * constant (see the ':shared' 'generateChangelog' task), so both Android and iOS share the same
 * source - no platform input is required.
 */
