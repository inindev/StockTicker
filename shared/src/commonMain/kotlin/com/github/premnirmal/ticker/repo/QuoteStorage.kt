...
/**
 * Platform-neutral contract for persisting the user's quotes, holdings and per-quote properties.
 * (The set of watched symbols itself now lives in the Room-backed 'WatchlistRepository' - All Symbols
 * - not here.) All of its inputs/outputs are already-shared 'commonMain' models
